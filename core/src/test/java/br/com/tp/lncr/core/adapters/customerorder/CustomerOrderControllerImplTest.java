...
class CustomerOrderControllerImplTest {
    ...
    @Test
    void testGetById() {
        when(customerOrderDatabase.findCustomerOrderById(1,true)).thenReturn(customerOrderDTO);
    ...
    void testGetByStatusList() {
        ...
        when(customerOrderGateway.getCustomerOrderByStatusList(statusListIds,true)).thenReturn(List.of(actualCustomerOrder));
