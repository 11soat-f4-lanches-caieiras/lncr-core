...
public class GetFoodItemUseCase {
    ...
    public FoodItem getById(Integer foodItemId, Boolean includeImages) {
        LoggerUtil.info("Iniciando busca de item de alimentação com id: " + foodItemId + ", incluir imagens: " + includeImages);
        ...
        LoggerUtil.info("Item de alimentação encontrado: " + foodItem.getName());
        return foodItem;
    }

    public List<FoodItem> getByIdList(List<Integer> foodItemIds) {
        LoggerUtil.info("Iniciando busca de itens de alimentação com ids: " + foodItemIds);
