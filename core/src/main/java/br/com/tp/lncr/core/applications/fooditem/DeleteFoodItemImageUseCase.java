...
public class DeleteFoodItemImageUseCase {
    ...
    public void deleteImagesByFoodItemId(Integer foodItemId) {
        LoggerUtil.info("Iniciando exclusão de imagens do item de alimentação com id: " + foodItemId);
        ...
        LoggerUtil.info("Imagens do item de alimentação com id: " + foodItemId + " excluídas com sucesso.");
    }


    public void deleteById(Integer foodItemImageId) {
        LoggerUtil.info("Iniciando exclusão de imagem com id: " + foodItemImageId);
        ...
        LoggerUtil.info("Imagem com id: " + foodItemImageId + " excluída com sucesso.");
    }
}
